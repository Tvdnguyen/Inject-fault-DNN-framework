...
if __name__ == "__main__":
    ...
    while num_fail_trials < 100:
        ...
        print(f"Trial faul rate 1.55e-4 {total_trials + 1}: Accuracy = {accuracy:.2f}%")
        if accuracy <= 78.255:
            trial_results.append(accuracy)
            num_fail_trials += 1
            print(f"Trial faul rate 1.55e-4 (<=78.255) {num_fail_trials}: Accuracy = {accuracy:.2f}%")
        total_trials += 1
